...
class knime_runner():
    ...
    def _workflow_finished(self):
        ...
        for item in os.listdir(self._plugin._output_directory.name):
            ...
            if item.lower().endswith('.sdf') and ligand:
                ...
                self._structure = nanome.structure.Complex.io.from_sdf(path=source)
                Logs.debug("structure - positon:", self._structure.position, "rotation,", self._structure.rotation)
                if ligand:
                    ligand = False
    ...
    def align_callback(self):
        ...
        Logs.debug("structure updated - positon:", self._structure.position, "rotation,", self._structure.rotation)
